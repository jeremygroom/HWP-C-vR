...
#get(eval(paste0("hwp.data$", "Harvest_BF")))

#hwp.data[[which(names(hwp.data) == "Harvest_BF")]]
...
harv_hwp <- tC.read("Harvest_BF"); harv.hwp <- harv_hwp$tble; terminate$harv_hwp[1] <- harv_hwp$term; error.report$harv_hwp[1] <- harv_hwp$msg
